...
#define DAT_Clda {0.0440, 0.0439, 0.0437, 0.0435, 0.0434, 0.0432, 0.0431, 0.0429, 0.0428, 0.0427, 0.0426, 0.0426, 0.0425, 0.0425, 0.0425, 0.0426, 0.0427, 0.0428, 0.0430, 0.0434, 0.0438, 0.0437, 0.0429, 0.0415, 0.0398, 0.0383, 0.0367, 0.0353, 0.0340, 0.0331, 0.0322, 0.0313, 0.0304, 0.0293, 0.0283, 0.0274, 0.0265, 0.0255, 0.0246, 0.0238, 0.0231, 0.0224, 0.0218, 0.0211, 0.0205, 0.0198, 0.0191, 0.0186, 0.0181, 0.0177, 0.0172, 0.0169, 0.0166, 0.0163, 0.0160, 0.0157, 0.0155, 0.0152, 0.0150, 0.0147, 0.0145, 0.0144, 0.0142,}
#define CON_Cldamin 0.4302
...
//-----------Beginn Engine Data---------------------
#define DAT_PMax {55227, 52748, 50227, 47876, 46919, 47997, 48412, 46745, 47610, 48699, 47711, 44357, 44305, 44858, 44490, 44571, 42858, 41715, 43834, 43575, 42010, 35025, 25250, 24514, 23547, 22958, 22525, 22415, 23998, 22874, 21985, 20150,}
#define CON_PMaxmin 0 //kn airspeed SL
#define CON_PMaxmax 1984

#define DAT_PFor {85976, 84875, 84720, 85785, 86763, 90148, 93186, 98684, 110545, 125441, 123384, 129721, 123014, 138879, 141258, 144333, 144879, 145178, 145223, 139478, 136524, 136524, 128974, 100214, 65124, 34750, 34750, 34750, 34750, 34750, 34750,} 
#define CON_PFormin 0
#define CON_PFormax 1984 //kn airspeed at SL
...
#define CON_sDay_den 1.229 // kg/m³ Airdensity
